...
%use the following elastic variants of vfill and newpage to enable collapsing
%in the change these variables section above
...
\item You will have 50 minutes to complete this exam.  One may use an approved calculator, but no notes or books are allowed.
...
\begin{parts}
    \part[5] Find the point(s) where $f(x,y)$ has possible relative maxima or minima.
  \elasticvfill
